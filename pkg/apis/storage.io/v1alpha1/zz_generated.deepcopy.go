...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HdfsClusterlList) DeepCopyInto(out *HdfsClusterlList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HdfsClusterlList.
func (in *HdfsClusterlList) DeepCopy() *HdfsClusterlList {
	if in == nil {
		return nil
	}
	out := new(HdfsClusterlList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *HdfsClusterlList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
